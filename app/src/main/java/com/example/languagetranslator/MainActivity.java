...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView micIV, camIV;
    private MaterialButton translateBtn;
    private TextView translatedTV;
    String[] fromLanguages={"From","English","Tamil","Telugu","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};
    String[] toLanguages={"To","English","Tamil","Telugu","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter fromAdapter=new ArrayAdapter(this,R.layout.spinnner_item,fromLanguages);
        ...
        ArrayAdapter toAdapter=new ArrayAdapter(this,R.layout.spinnner_item,toLanguages);
        ...
        camIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent p = new Intent(MainActivity.this,ScanningActivity.class);
                p.putExtra("fromLanguages",fromLanguageCode);
                p.putExtra("toLanguages",toLanguageCode);
                startActivity(p);
            }
        });
